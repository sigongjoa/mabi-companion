    ...
    <div className="p-6 space-y-6 bg-gray-50 min-h-screen">
      <div className="document-card p-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">타이머 관리</h1>
            <p className="text-gray-600">재화 충전 및 게임 이벤트 타이머</p>
          </div>
            ...
            <CardContent className="p-4">
              <div className="space-y-3 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{gameEvents.length}개</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">다음 초기화</span>
                  <span className="font-medium text-blue-600">4시간 23분</span>
                </div>
              </div>
            </CardContent>
          </Card>
